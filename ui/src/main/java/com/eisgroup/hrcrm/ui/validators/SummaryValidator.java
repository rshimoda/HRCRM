...
@FacesValidator("summaryValidator")
public class SummaryValidator implements Validator {
    ...
    public void validate(FacesContext facesContext, UIComponent uiComponent, Object object) throws ValidatorException {
        ...
        if (summary.length() > 2048) {
            throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR, "", resourceBundle.getString("TaskValidation.SummaryLength")));
        }
